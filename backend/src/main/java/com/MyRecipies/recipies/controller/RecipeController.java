...
public class RecipeController {
    ...
    public ResponseEntity<List<RecipeVersionDTO>> findVersions(@PathVariable Long id) {

        List<RecipeVersionDTO> listDTO = service.findVersions(id);
        return ResponseEntity.ok(listDTO);
    }

    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_CLIENT')")
    @GetMapping(value = "/{id}/versions/{versionId}")
    public ResponseEntity<RecipeVersionDTO> findVersionById(@PathVariable Long id, @PathVariable Long versionId) {
